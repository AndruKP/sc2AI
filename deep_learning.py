    ...
    async def intel(self):
        ...
        for unit_type in draw_dict:
            for unit in self.units(unit_type).ready:
                ...
                cv2.circle(game_data, (int(nex_pos[0]), int(nex_pos[1])), draw_dict[unit_type][0],
                           draw_dict[unit_type][1])

        main_base_names = ["nexus", "commandcenter", 'orbitalcommand', "planetaryfortress", "hatchery", "lair", "hive"]
